...
const handleProduceRequest = async (jsonMessage) => {
  ...
  console.log("jsonMessage.rtpParameters:", jsonMessage.rtpParameters);
...
const publishProducerRtpStream = async (
  ...
  console.log("producer.rtpParameters:", producer.rtpParameters);
...
const getProcess = (recordInfo) => new FFmpeg(recordInfo);
